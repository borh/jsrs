...
def ratings_page(request):
    ...
    # print('ratings_page entered with {}'.format(request.method))
    ...
    if request.method == 'POST':
        ...
        # print('F:{}, valid?:{}'.format([sound_file_a, sound_file_b], form.is_valid()))
        # check whether it's valid:
        if form.is_valid():
            # process the data in form.cleaned_data as required
            # ...
            # redirect to a new URL:
            # print('R:{}, choice:{}\nF:{}'.format([form.cleaned_data['audio_a'], form.cleaned_data['audio_b']], form['a_gt_b'], form))
            r = Ratings(audio_a=form.cleaned_data['audio_a'], audio_b=form.cleaned_data['audio_b'], user=request.user, a_gt_b=form.cleaned_data['a_gt_b'])
